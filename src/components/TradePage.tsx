...
import { User, ChevronDown, Gem, Coins, Timer, Search, X, Filter, ArrowUpDown, ArrowRightLeft, Plus } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-200 to-blue-300 pb-24">
      ...
      <div className="mt-2 px-4 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-3xl font-black text-gray-800 drop-shadow-sm">Trade Center</h1>
