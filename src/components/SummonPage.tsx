...
const CHARACTER_POOL = [
   {
      ...
      dropRate: 70.0,
      amount: 20,
      couponDropRate: 2, // 2% chance to drop a coupon
      couponType: '5%', // 5% discount coupon
   ...
   },
   {
      ...
      dropRate: 70.0,
      amount: 50,
      couponDropRate: 3, // 3% chance to drop a coupon
      couponType: '8%', // 8% discount coupon
   ...
   },
   {
      ...
      amount: 100,
      couponDropRate: 3, // 3% chance to drop a coupon
      couponType: '10%', // 10% discount coupon
   ...
   },
   {
      ...
      dropRate: 70.0,
      amount: 200,
      couponDropRate: 4, // 4% chance to drop a coupon
      couponType: '12%', // 12% discount coupon
   ...
   },
   {
      ...
      dropRate: 15.0,
      amount: 20,
      couponDropRate: 7, // 7% chance to drop a coupon
      couponType: '15%', // 15% discount coupon
   ...
   },
   {
      ...
      dropRate: 15.0,
      amount: 100,
      couponDropRate: 8, // 8% chance to drop a coupon
      couponType: '18%', // 18% discount coupon
   ...
   },
   {
      ...
      dropRate: 15.0,
      amount: 50,
      couponDropRate: 9, // 9% chance to drop a coupon
      couponType: '20%', // 20% discount coupon
   ...
   },
   {
      ...
      dropRate: 10.0,
      amount: 200,
      couponDropRate: 12, // 12% chance to drop a coupon
      couponType: '25%', // 25% discount coupon
   ...
   },
   {
      ...
      dropRate: 10.0,
      amount: 20,
      couponDropRate: 15, // 15% chance to drop a coupon
      couponType: '30%', // 30% discount coupon
   ...
   },
   {
      ...
      dropRate: 5.0,
      amount: 20,
      couponDropRate: 20, // 20% chance to drop a coupon
      couponType: '50%', // 50% discount coupon
      description: 'The gentle glow of the moon illuminates this rare and mystical creature.'
   }
]
...
const SummonPage = () => {
   ...
   const handleSummon = (isTenDraw: boolean) => {
      ...
      if (!selectedStore || selectedStore.point < drawCost) {
         console.log(
            `You only have ${selectedStore?.point || 0} ${selectedStore?.name || ''} points. Need ${drawCost} points.`
         )
         return
      }
            ...
            <div className='relative w-80 h-80'>
               ...
               <div className='absolute inset-0 animate-float'>
                  <div className='relative w-48 h-60 mx-auto'>
                     <div
                        className={`absolute inset-0 bg-gradient-to-br ${styles.egg} rounded-[45%] shadow-xl ${
                           ...
                           {[...Array(6)].map((_, i) => (
                              <div
                                 ...
                                 className={`absolute w-4 h-4 rounded-full ${
                                    characters[0]?.rarity === 'legendary' ? 'bg-yellow-300' : 'bg-purple-300'
                                 } animate-sparkle`}
                                 style={{
                                    top: `${Math.random() * 100}%`,
